# Overlay of microsoft/vcpkg ports/zstd: disable multithreaded zstd on iOS so the installed
# CMake package does not call find_dependency(Threads). Downstream ports (e.g. ktx) then
# configure without FindThreads failing on iphoneOS try_compile.
vcpkg_from_github(
...
if(VCPKG_TARGET_IS_IOS)
    set(ZSTD_MULTITHREAD_SUPPORT 0)
else()
    set(ZSTD_MULTITHREAD_SUPPORT 1)
endif()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DZSTD_MULTITHREAD_SUPPORT=${ZSTD_MULTITHREAD_SUPPORT}
    OPTIONS_RELEASE
